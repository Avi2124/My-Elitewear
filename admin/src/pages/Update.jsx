        ...
        <div className="flex flex-col sm:flex-row justify-between gap-4">
          <div>
            <h1 className="text-3xl font-light tracking-wide flex items-center">
              <Edit3Icon className="h-8 w-8 mr-3 text-indigo-200" />
              Update Product
            </h1>
          ...
          {existingImages.length > 0 && (
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 mb-6">
              {existingImages.map((img, index) => (
                <div
                  key={index}
                  className="aspect-square rounded-xl overflow-hidden border bg-white"
                >
                  <img
                    src={img}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            {images.map((img, index) => (
              <label
                ...
                className={`relative group aspect-square rounded-xl overflow-hidden transition border ${
                  img
