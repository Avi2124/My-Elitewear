...
const Login = ({ setToken }) => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen w-full bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="bg-white rounded-xl shadow-2xl px-10 py-12 w-full max-w-md mx-4">
        ...
        <form onSubmit={onSubmitHandler} className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                id="password"
                className="block w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200"
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          <p>© {new Date().getFullYear()} ELITEwear. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
