  ...
  const policies = [
    {
      ...
      title: "EASY EXCHANGE",
      description:
        "Hassle-free exchanges within 14 days for unworn, unwashed items with original tags.",
    ...
    },
    {
      ...
      title: "7 DAY RETURNS",
      description:
        "Full refunds on unworn items returned within 7 days of delivery.",
    ...
    },
    {
      ...
      title: "24/7 SUPPORT",
      description:
        "Dedicated customer care available round the clock via chat, email, or phone.",
    ...
    },
    {
      ...
      title: "FAST SHIPPING",
      description:
        "Free standard shipping on all orders. Express delivery available.",
    ...
    },
    {
      ...
      title: "GIFT SERVICES",
      description:
        "Free gift wrapping and personalized message with every order.",
    ...
    },
    {
      ...
      description:
        "100% authentic products with strict quality control checks.",
    ...
    <div className="bg-white py-16 sm:py-24 border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-0">
        <div className="text-center mb-16">
          <h2 className="text-2xl sm:text-3xl font-light tracking-wider mb-4">
            OUR COMMITMENT TO YOU
          </h2>
          <p className="text-gray-500 max-w-2xl mx-auto text-sm sm:text-base">
            We stand behind every product we sell with policies designed for
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12">
          {policies.map((policy, index) => (
            ...
            >
              ...
              <p className="text-xs text-gray-400 mt-3">{policy.extra}</p>
            </div>
          ))}
        </div>
        ...
        <div className="mt-16 text-center border-t border-gray-100 pt-16">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto text-sm sm:text-base mb-6">
            Our customer care team is ready to assist with any questions about
            our policies or your order.
          </p>
          <a
            href="/contact"
            target="_blank"
