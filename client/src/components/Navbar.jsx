...
const Navbar = () => {
  ...
  const { getCartCount, navigate, token, setToken, setCartItems, performSearch, searchQuery, setSearchQuery, showSearchBar, setShowSearchBar } = useContext(ShopContext);
