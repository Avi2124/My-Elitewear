...
const BestSeller = () => {
  ...
  const bestSellers = [...products].filter((item) => item.bestseller).reverse();
    ...
    <div className="max-w-7xl mx-auto px-0">
      <div className="text-center mb-12">
        ...
        <p className="mt-4 max-w-2xl mx-auto text-sm md:text-base text-gray-500 font-light tracking-wide">
          Exquisite selections adored by our most discerning clientele. Each
          piece embodies unparalleled craftsmanship.
        </p>
      </div>
