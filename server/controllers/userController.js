...
const removeUser = async(req, res) => {
  try {
    ...
    return res.json({sucess: true, message: " User deleted successfully"});
  } catch (error) {
    console.log(error);
    res.json({success: false, message: error.message});
  }
...
export { loginUser, registerUser, listUsers, removeUser, adminLogin, changePassword };
